...
public class ResultsActivities {
    ...
    public ResultsActivities assertTitleListIsNotEmpty() {
    ...
    @Step("Click to link")
    public ResultsActivities clickToListItemDescription(String expectedResult) {
